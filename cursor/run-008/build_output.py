"""Build run-008: no answer cognates in question (example 5/10), JSON/TXT/README."""
import json
...
EXAMPLES = [
    ...
    },
    {
        ...
        "cards": [
            ...
            {"question": "В ответе «Своей игры» первое слово фразы из двух слов пишут с буквой «я» — ЭТО.", "answer": "Тысяча", "logic": "Без «тыща» в вопросе — однокоренность (пример 5)."},
        ],
    },
    {
        "id": "colt-peacemaker",
    ...
    },
    {
        ...
        "tags": ["text-only", "term"],
        "cards": [
            {"question": "Низкокачественный массовый контент от генеративных моделей в сленге называют ЭТИМ.", "answer": "нейропомои", "logic": "Без корня «нейро-» в вопросе (примеры 5, 10)."},
    ...
    },
    {
        ...
        "cards": [
            {"question": "Известное торговое соглашение между СССР и Израилем.", "answer": "апельсиновая сделка", "logic": "Описательно, без «сделка»/«апельсин» (пример 5)."},
            {"question": "По популярной версии, Чебурашка приехал в СССР из ящика с цитрусовыми из ЭТОЙ страны.", "answer": "Израиль", "logic": "Без «апельсин» в вопросе (пример 5)."},
            {"question": "Второй стороной того же соглашения был ЭТОТ государственный союз.", "answer": "СССР", "logic": "Без названия сделки в вопросе (пример 5)."},
        ],
    },
    {
        "id": "miracle-on-grass",
    ...
    },
    {
        ...
        "tags": ["text-only", "term"],
        "cards": [
            {"question": "Корабль, собранный из частей двух британских эсминцев, назывался ТАК — на английском.", "answer": "HMS Zubian", "logic": "Без Zulu/Nubian в вопросе — части ответа (пример 5)."},
        ],
    },
    {
        "id": "palmer-pilgrim",
    ...
    },
    {
        ...
        "tags": ["link-only", "term"],
        "cards": [
            {"question": "Вероятностную структуру данных для проверки принадлежности элемента множеству называют ИМ.", "answer": "фильтр Блума", "logic": "ИМ вместо «ЭТИМ … фильтром» (пример 10)."},
            {"question": "Идею такой структуры предложил Бёртон Блум В ЭТОМ ГОДУ.", "answer": "1970", "logic": "Без «фильтр» в вопросе (пример 5); только год → В ЭТОМ ГОДУ."},
            {"question": "Автором идеи такой структуры считается ОН.", "answer": "Бёртон Блум", "logic": "Без «фильтр»/«Блум» в вопросе (пример 5)."},
        ],
    },
    {
        "id": "alferov-nobel",
    ...
    },
    {
        ...
        "tags": ["text-only", "term"],
        "cards": [
            {"question": "В Кёльнском соборе предмет с мрачным прозвищем называют ЭТИМ по-немецки — на немецком.", "answer": "Blutglocke", "logic": "Без «колокол» в вопросе — cognate к Glocke (пример 5)."},
    ...
    },
    {
        ...
        "tags": ["link+comment", "term"],
        "cards": [
            {"question": "Группу охотничьих собак-апортировщиков в англоязычной терминологии называют ЭТИМ.", "answer": "ретривер", "logic": "Без retrieve/retriever в вопросе (пример 5)."},
            {"question": "От английского глагола «приносить обратно» в охотничьем контексте по-русски назвали ЭТУ группу собак.", "answer": "ретривер", "logic": "Без retrieve/retriever в вопросе (пример 5)."},
        ],
    },
    {
    ...
    },
    {
        ...
        "tags": ["text-only", "term"],
        "cards": [
            {"question": "Самую длинную междугороднюю линию на электротранспорте в мире проложили между Симферополем и Ялтой — она называется ТАК.", "answer": "Крымский троллейбус", "logic": "Без «троллейбус» в вопросе (пример 5); название → ТАК (пример 4)."},
            {"question": "Длина этой линии составляет примерно ЭТО километров.", "answer": "86", "logic": "Без «троллейбус»/«Крымский» в вопросе (пример 5)."},
        ],
    },
    {
