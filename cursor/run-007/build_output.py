"""Build run-007: curated cards (example 4 — ТАК + full titles), JSON/TXT/README."""
import json
...
EXAMPLES = [
    {
        ...
        "cards": [
            ...
            {"question": "Крупнейшая волонтёрская цифровая библиотека свободных книг называется ТАК.", "answer": "Проект «Гутенберг»", "logic": "Официальное название → ТАК + полный ответ (пример 4)."},
        ],
    },
    {
        "id": "tysyacha-bogov",
    ...
    },
    {
        ...
        "cards": [
            {"question": "В рассказе о сыщике из Бейкер-стрит шифр читали, выбирая каждое третье слово; рассказ называется ТАК.", "answer": "«Глория Скотт»", "logic": "Название произведения → ТАК + полный ответ (пример 4)."},
    ...
    },
    {
        ...
        "cards": [
            ...
            {"question": "Певца, растерзанного менадами, звали — ОН.", "answer": "Орфей", "logic": "Персона → ОН, не ЭТИМ (пример 1)."},
        ],
    },
    {
        "id": "hms-zubian",
        ...
        "tags": ["text-only", "term"],
        "cards": [
            {"question": "Корабль, собранный из частей HMS Zulu и HMS Nubian, назывался ТАК — на английском.", "answer": "HMS Zubian", "logic": "Официальное название → ТАК (пример 4); язык объявлен."},
        ],
    },
    {
        "id": "palmer-pilgrim",
    ...
    },
    {
        ...
        "cards": [
            ...
            {"question": "Картину Милле с тремя игральными картами в оригинале называется ТАК — на английском.", "answer": "Hearts are Trumps", "logic": "Название произведения → ТАК (пример 4); язык объявлен."},
        ],
    },
    {
        "id": "total-war-speech",
    ...
    },
    {
        ...
        "cards": [
            ...
            {"question": "Мультсериал о псе и детективах — один из самых долгих в истории анимации; его героя зовут ТАК.", "answer": "Скуби-Ду", "logic": "Официальное имя персонажа → ТАК (пример 4)."},
        ],
    },
    {
        "id": "yeltsin-memoirs",
    ...
    },
    {
        ...
        "cards": [
            {"question": "В «Большом Лебовски» герой цитирует песню The Beatles, которая называется ТАК — на английском.", "answer": "I Am the Walrus", "logic": "Название произведения → ТАК (пример 4); язык объявлен."},
        ],
    },
    {
        "id": "lonely-rooster",
    ...
    },
    {
        ...
        "cards": [
            {"question": "После чтения «Малахитовой шкатулки» Сергей Сергеевич Прокофьев создал балет, который называется ТАК.", "answer": "«Каменный цветок»", "logic": "Название произведения → ТАК + полный ответ (пример 4)."},
    ...
    },
    {
        ...
        "cards": [
            ...
            {"question": "Оригинальное название того же фильма на английском называется ТАК.", "answer": "Crouching Tiger, Hidden Dragon", "logic": "Название фильма → ТАК (пример 4); язык объявлен."},
        ],
    },
    {
        ...
        "tags": ["text-only", "literature"],
        "cards": [
            {"question": "Экспериментальный роман почти без глаголов называется ТАК.", "answer": "«Поезд из ниоткуда»", "logic": "Название произведения → ТАК + полный ответ (пример 4)."},
    ...
    },
    {
        ...
        "cards": [
            {"question": "Первая часть цикла «В поисках утраченного времени» называется ТАК.", "answer": "«По направлению к Свану»", "logic": "Название произведения → ТАК + полный ответ (пример 4)."},
    ...
    },
    {
        ...
        "cards": [
            {"question": "Ацтекскую богиню, чьё имя переводят как «обсидиановая бабочка», звали — ОНА.", "answer": "Ицпапалотль", "logic": "Персона (ж.р.) → ОНА, не ЭТИМ (пример 1)."},
    ...
    },
    {
        ...
        "cards": [
            {"question": "Прозвище венецианского художника переводят как «маленький красильщик» — его звали ОН.", "answer": "Якопо Тинторетто", "logic": "Персона → ОН + полное имя (примеры 1, 8)."},
    ...
    },
    {
        ...
        "tags": ["text-only", "literature"],
        "cards": [
            {"question": "В романе Ильфа и Петрова Остап Бендер охотится за миллионером Корейко — роман называется ТАК.", "answer": "«Золотой телёнок»", "logic": "Название произведения → ТАК + полный ответ (пример 4)."},
    ...
    },
    {
        ...
        "tags": ["text-only", "term"],
        "cards": [
            {"question": "Самую длинную междугороднюю троллейбусную линию в мире проложили между Симферополем и Ялтой — она называется ТАК.", "answer": "Крымский троллейбус", "logic": "Официальное название → ТАК + полный ответ (пример 4)."},
